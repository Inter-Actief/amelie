...
from amelie.activities import views, ajax_views
...
urlpatterns = [
    ...
    path('<int:pk>/ajax/participants/', ajax_views.ActivityParticipationsView.as_view(), name='activity_participations'),
    path('<int:activity_id>/ajax/participants/<int:pk>/payments/', ajax_views.ActivityParticipationPaymentsView.as_view(), name='activity_participation_payments'),
    path('<int:activity_id>/ajax/participants/<int:pk>/payment_create/', ajax_views.ActivityParticipationCreatePaymentView.as_view(), name='activity_participation_create_payment'),
