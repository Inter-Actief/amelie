...
urlpatterns = [
    ...
    path('<int:id>/ajax/membership/<int:membership>/payments/', ajax_views.person_membership_payments, name='person_membership_payments'),
    path('<int:id>/ajax/membership/<int:membership>/payment_create/', ajax_views.MembershipCreatePaymentView.as_view(), name='person_membership_create_payment'),
    ...
    path('<int:id>/ajax/mandate/edit/<int:mandate>/', ajax_views.person_mandate_edit, name='person_mandate_edit'),
    path('<int:id>/ajax/mandate/delete/<int:mandate>/', ajax_views.person_mandate_delete, name='person_mandate_delete'),
