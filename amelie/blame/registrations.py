...
from amelie.members.models import Person, Committee, Faculty, Department, Study, Dogroup, \
    DogroupGeneration, Association, CommitteeCategory, Function
...
from amelie.personal_tab.models import DiscountPeriod, CustomTransaction, ManualPaymentSettlement, LedgerAccount, \
    Article, Category as CookieCornerCategory, AuthorizationType, Authorization, Amendment, PrintLogEntry, PaymentMethod
...
auditlog.register(ManualPaymentSettlement)
